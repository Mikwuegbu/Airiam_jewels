...
const Home = () => {
	return (
		<div className="bg-[#FFF8E7]">
			<div className="grid justify-center place-items-center lg:text-left text-center px-6 gap-y-3 lg:py-0 py-4 lg:grid-flow-col">
				<div className="space-y-3 lg:space-y-9 max-w-[624px]">
					<h1 className="font-MerriWeather text-3xl lg:text-5xl font-bold text-nowrap">
						Define your style
						<br /> Shop now, discover.
					</h1>
					<p className="font-normal text-sm lg:text-2xl font-Raleway">
				...
				<div className="">
					<img
						src={heroBg}
						alt={heroBg}
						className="w-[249px] h-[283px] lg:w-[612px] lg:h-[696px] "
					/>
				</div>
			</div>
		</div>
